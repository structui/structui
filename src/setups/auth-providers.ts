...
function generateNextAuth(): AuthProviderResult {
  return {
    files: [
      {
        path: "lib/auth.ts",
...
function generateBetterAuth(): AuthProviderResult {
  return {
    files: [
      {
        path: "lib/auth.ts",
...
function generateBasicAuth(): AuthProviderResult {
  return {
    files: [
      {
        path: "lib/auth.ts",
...
export function generateAuthProvider(provider: AuthProvider): AuthProviderResult {
  switch (provider) {
    case "next-auth":
