...
export function rootLayout(options: SetupOptions): SetupFile {
...
export function globalsCss(): SetupFile {
  return {
...
export function authLayout(options: SetupOptions): SetupFile {
...
export function signInPage(options: SetupOptions): SetupFile {
...
export function signUpPage(options: SetupOptions): SetupFile {
  const { projectTitle, colorPalette } = options;
  return {
...
export function sidebar(options: SetupOptions, navItems: NavItem[]): SetupFile {
  const { projectTitle, colorPalette } = options;
...
export function header(options: SetupOptions, pageTitle: string): SetupFile {
  const { colorPalette } = options;
  return {
...
export function footer(options: SetupOptions): SetupFile {
  const { projectTitle, colorPalette } = options;
  return {
...
export function profilePage(options: SetupOptions, layoutPrefix: string): SetupFile {
  const { projectTitle, colorPalette } = options;
  return {
...
export function sharedFiles(options: SetupOptions): SetupFile[] {
