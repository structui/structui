...
export const buttonComponent: ComponentRegistryEntry = {
  ...
  llmSummary:
    "Use Button for primary and secondary actions. Supports variants, sizes, icons, loading states, and polymorphic rendering via asChild.",
  category: "General",
  status: "stable",
  docsStatus: "ready",
  visibility: "public",
  ...
  sourceExport: "Button",
  docsPath: "src/content/docs/components/button.md",
  dependencies: ["@radix-ui/react-slot", "class-variance-authority"],
  registryDependencies: [],
  relatedComponents: ["badge", "accordion"],
};
