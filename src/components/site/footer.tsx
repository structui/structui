      ...
      <div className="mx-auto max-w-7xl px-4 py-14 sm:px-6 lg:px-8">
        <div className="grid grid-cols-2 gap-x-6 gap-y-12 sm:grid-cols-2 lg:grid-cols-12">
          ...
          <div className="col-span-2 lg:col-span-3">
            ...
            <div className="space-y-2.5 rounded-2xl border border-border/50 bg-muted/20 p-4">
              {[
                { label: "Registry API", ok: true },
                { label: "CDN Assets", ok: true },
            ...
            <div className="mt-3 flex items-center gap-2">
              <span className="rounded-full border border-border/60 bg-muted/40 px-2.5 py-1 text-[10.5px] font-mono font-medium text-muted-foreground">
                v1.4.0
              </span>
              <span className="rounded-full border border-primary/20 bg-primary/8 px-2.5 py-1 text-[10.5px] font-medium text-primary">
                MIT License
              </span>
            </div>
          </div>
